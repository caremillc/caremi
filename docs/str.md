...
The `Careminate\Supports\Str` class offers a robust set of static utility methods for string manipulation.  
...
Utility maintained under `Careminate\Supports\Str`