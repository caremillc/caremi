...
The `Careminate\Supports\Arr` class provides a collection of powerful, static utility methods for working with arrays in PHP.  
...
Utility maintained under `Careminate\Supports\Arr`
